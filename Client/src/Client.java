...
public class Client {
	...
	int portNumber = 0;
	String clientName;
	static String itemDescription; // the description of the current item so that the
...
//				}
			...
			System.out.println("If you want to stay in the auction press yes orelse press no!");
	...
	private void bid() throws IOException {
		...
		System.out.println("press list_history for bidding history or description for item description");
...
//					}
	...
	private void takeRequest() throws IOException, InterruptedException {
		...
		System.out.println("If you are interested about the item write : interested");
